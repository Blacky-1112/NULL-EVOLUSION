...
void POLYGONFILTER::Init(float x, float y, float w, float h, const char* FileName)
{
	VERTEX_3D vertex[4];
	...
	//シェーダー読み込み
	Renderer::CreateVertexShader(&m_VertexShader, &m_VertexLayout, "shader\\filterVS.cso");

	Renderer::CreatePixelShader(&m_PixelShader, "shader\\filterPS.cso");
}
