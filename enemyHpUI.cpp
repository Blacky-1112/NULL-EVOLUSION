...
void EnemyHPUI::Init()
{
	...
	Manager::GetScene()->AddGameObject<Polygon2D>(2)->Init(tx - 20, ty - 10,maxRate + 20,th + 20, "asset\\texture\\HPFrame.png");
}

void EnemyHPUI::Uninit()
{
...
void EnemyHPUI::Update()
{
	...
	float rate = pEnemy->GetLife() * 0.01f;

	m_Color = XMFLOAT4(1.0f - rate, rate, 0.0f, 1.0f);
