...
//			m_Particle[i].Velocity.x = (rand() % 200 - 100) / 300.0f;
//			m_Particle[i].Velocity.y = (rand() % 200 - 100) / 300.0f;
//			//m_Particle[i].Velocity.z = (rand() % 100) / 500.0f;
//
//			m_Particle[i].Diffuse.x = (rand() % 9 + 1) / 10.0f;
//			m_Particle[i].Diffuse.y = (rand() % 9 + 1) / 10.0f;
//			m_Particle[i].Diffuse.z = (rand() % 9 + 1) / 10.0f;
//
...
//				trans = XMMatrixTranslation(m_Particle[i].Position.x + offset, m_Particle[i].Position.y, m_Particle[i].Position.z);
